...
export interface ApiProgramadorProgramador extends Struct.CollectionTypeSchema {
  collectionName: 'programadores';
  info: {
    displayName: 'Programador';
    pluralName: 'programadores';
  ...
  attributes: {
    ...
    correoContacto: Schema.Attribute.Email;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcionBreve: Schema.Attribute.Text;
    descripcionCompleta: Schema.Attribute.Text;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'nombreCompleto'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProyectoProyecto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    tecnologias: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiTecnologiaTecnologia extends Struct.CollectionTypeSchema {
